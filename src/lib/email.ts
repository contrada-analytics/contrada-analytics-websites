...
export async function sendLeadNotification(data: LeadNotificationData) {
  ...
  const emailHtml = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #0F1B2D; border-bottom: 3px solid #2E74B5; padding-bottom: 10px;">
        New Lead Submission - DataArk Labs
      </h2>

      <div style="background-color: #f5f5f5; padding: 20px; border-radius: 5px; margin: 20px 0;">
        <h3 style="color: #0F1B2D; margin-top: 0;">Contact Information</h3>
      ...
      <div style="background-color: #f5f5f5; padding: 20px; border-radius: 5px; margin: 20px 0;">
        <h3 style="color: #0F1B2D; margin-top: 0;">Company Details</h3>
      ...
      <div style="background-color: #f5f5f5; padding: 20px; border-radius: 5px; margin: 20px 0;">
        <h3 style="color: #0F1B2D; margin-top: 0;">Message</h3>
